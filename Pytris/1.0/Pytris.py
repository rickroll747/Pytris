...
def draw_score(screen, score):
    """Draw the score in a seven-segment style."""
    font = pygame.font.Font(pygame.font.match_font('consolas', True), 48)  # Using a monospace font
...
def main():
    ...
    while running:
        ...
        if current_tetromino.is_dropping:
            ...
            if current_tetromino.drop_timer >= 800:
